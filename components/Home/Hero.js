...
import { SignUpSelectorModal } from "../modals/SignUpSelectorModal";
    ...
    <>
      ...
      <div className="w-full h-max lg:pt-52 pt-40 pb-10 lg:pb-20 px-10 lg:px-20 flex flex-col items-center justify-center bg-mainBG fade-in-down relative">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-[5rem] leading-[2.5rem] md:leading-[4rem] lg:leading-[5rem] text-center jost-medium">
          Transform{" "}
          <span className="text-mainYellow ">employee well-being</span>{" "}
        ...
        <div className="flex flex-row items-center justify-center mt-10 lg:mt-16 gap-4">
          <button
            ...
            className="bg-mainBlue border hover:bg-mainYellow hover:text-mainBlue hover:border-mainYellow transition-all duration-500 border-mainBlue text-white px-4 lg:px-6 py-2 rounded-lg lg:rounded-xl text-xs lg:text-base jost-medium flex items-center gap-2 flex-row "
          >
